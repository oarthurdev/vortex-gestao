    ...
    switch (activeTab) {
      ...
      case "vencidas":
        ...
        return transactions.filter(
          (t) => t.status === "pendente" && new Date(t.dueDate) < today,
        );
      default:
        return transactions;
    }
  ...
  return (
    <div className="flex h-screen bg-background">
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        <TopBar
          title="Financeiro"
          subtitle="Controle de contas a pagar e receber"
        />
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          setFormData({
                            ...formData,
                            contractId: value === "" ? undefined : value,
                          })
                        }
                      >
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        setFormData({
                          ...formData,
                          status: value as "pendente" | "pago" | "vencido",
                        })
                      }
                    >
                      ...
                      <Popover>
                        ...
                        <PopoverContent className="w-auto p-0" align="start">
                          <Calendar
                            ...
                            onSelect={(date) =>
                              setFormData({ ...formData, paidDate: date })
                            }
                            initialFocus
                          />
                        </PopoverContent>
              ...
              <div className="text-center py-12">
                ...
                <p className="text-muted-foreground mb-4">
                  {activeTab === "all"
                    ...
                    : `Nenhuma transação ${activeTab} encontrada`}
                </p>
              </div>
            ) : (
                          ...
                          <div className="flex items-center gap-3 mb-2">
                            ...
                            <div>
                              <h4
                                ...
                                data-testid={`text-transaction-description-${transaction.id}`}
                              >
